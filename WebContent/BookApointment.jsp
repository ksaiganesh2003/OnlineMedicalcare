						...
						<div class="col-lg-6">
							<div class="panel-body">
								<label class="alert alert-info"
									style="font-size: 10px; width: 100%;">Note:You can book
									appointment from 10 AM to 22 PM <br>and after 1 hour from
									current time.
								</label>
								<center>
									<%
								...
								<hr>
								<form action="AppointmentReg.jsp" method="post" name="form"
									class="contactForm lead">
									<div class="row">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
											<div class="form-group">
												<label>Select Department</label> <select name='department'
													onchange="showDoctor(this.value)" required=""
													class="form-control">
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
											<div class="form-group">
												...
												<div id="fees">
													<select name='fees' required="" id="test"
														class="form-control">
										...
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
											<div class="form-group">
												...
												<div class="input-group date" id="datetimepicker">
													<input type="text" required="" name="appoint_date_time"
								...
								if (rss.next()) {
									out.println("<center><a style='color:red;' href='LastAppointment.jsp?id=" + pid
									+ "'>View your Last Appointment</a></center>");
								} else {
